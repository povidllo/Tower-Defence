...
public:
    ...
    void setupUi(QMainWindow *ProjectEditor)
    {
        ...
        actionCompile_project = new QAction(ProjectEditor);
        actionCompile_project->setObjectName("actionCompile_project");
        ...
        menuFile->addAction(actionCompile_project);
    ...
    void retranslateUi(QMainWindow *ProjectEditor)
    {
        ...
        actionCompile_project->setText(QCoreApplication::translate("ProjectEditor", "Compile project", nullptr));
